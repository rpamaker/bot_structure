...
class workspace_listener:
    ...
    def close(self):
        ...
        upload_log_s3(self.path_report, bucket_uri, "bot_logs/" + report_file)
        upload_log_s3(self.path_log, bucket_uri, "bot_logs/" + log_file)

        log_url = "https://" + bucket_uri + ".s3.amazonaws.com/bot_logs/" + log_file
        report_url = (
                "https://" + bucket_uri + ".s3.amazonaws.com/bot_logs/" + report_file
        )
